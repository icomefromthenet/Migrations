<?php
/**
 * File containing the Reader class.
 *
...
{
    /**
     * Contains a type map from MySQL native types to generic Schema types.
     *
     * @var array
     */
    ...
    /**
     * Converts the native MySQL type in $typeString to a generic Schema type.
     *
    ...
    static function convertToGenericType( $typeString, &$typeLength, &$typePrecision )
    {
        ...
        {
            throw new UnsupportedTypeException( 'MySQL', $matches[1] );
        }
