 ...
 * @version 1.4.4
 */
class ezcDbSchemaPhpArrayReader implements ezcFileReader, ezcFileDiffReader
{
    /**
     ...
     *         found.
     * @throws ezcInvalidSchemaException if the data in the $file is
    ...
    public function loadFromFile( $file )
    {
        ...
        {
            throw new ezcInvalidSchemaException( 'File does not have the correct structure' );
        }
    ...
    public function loadDiffFromFile( $file )
    {
        ...
        $schema = include $file;
        if ( !is_object( $schema ) || get_class( $schema ) != 'ezcDiff' )
        {
            throw new ezcInvalidSchemaException( 'File does not have the correct structure' );
        }
