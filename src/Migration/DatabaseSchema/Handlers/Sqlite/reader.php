 ...
 * @version 1.4.4
 */
class ezcDbSchemaSqliteReader extends ezcSqlReader implements ezcDatabaseReader
{
    /**
     * Contains a type map from SQLite native types to generic Schema types.
     *
     * @var array
     */
    ...
    /**
     * Converts the native SQLite type in $typeString to a generic Schema type.
     *
    ...
    static function convertToGenericType( $typeString, &$typeLength, &$typePrecision )
    {
        ...
        {
            throw new ezcUnsupportedTypeException( 'SQLite', $matches[1] );
        }
     ...
     * ezcIndex objects. The key in the array is the index' name.
     *
     * @param  string $tableName
     * @return array(string=>ezcIndex)
     */
