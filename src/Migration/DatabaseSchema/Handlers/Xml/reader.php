 ...
 * @version 1.4.4
 */
class ezcDbSchemaXmlReader implements ezcFileReader, ezcFileDiffReader
{
    /**
     ...
     *
     * @return ezcField or an inherited class
     */
     ...
     *
     * @return ezcIndex or an inherited class
     */
     ...
     *
     * @return ezcTable or an inherited class
     */
    ...
    /**
     * Returns the schema differences definition in $xml as an ezcDiff
     * 
     * @param SimpleXMLElement $xml
     *
     * @return ezcDiff
    ...
    private function parseDiffXml( SimpleXMLElement $xml )
    {
        ...
        return new ezcDiff( $newTables, $changedTables, $removedTables );
    }
     ...
     *         found.
     * @throws ezcInvalidSchemaException if the XML in the $file is
    ...
    private function openXmlFile( $file )
    {
        ...
        if ( !$xml )
        {
            throw new ezcInvalidSchemaException( "The schema file '{$file}' is not valid XML." );
        }
