<?php
/**
 * File containing the SchemaPgsqlReader class.
 *
...
namespace Migration\DatabaseSchema\Handlers\Pgsql;
...
{
    /**
     * Contains a type map from PostgreSQL native types to generic Schema types.
     *
     * @var array
     */
    ...
    /**
     * Converts the native PostgreSQL type in $typeString to a generic Schema type.
     *
     * This method converts a string like "float(5,10)" to the generic Schema
    ...
    static function convertToGenericType( $typeString, &$typeLength, &$typePrecision )
    {
        ...
        {
            throw new UnsupportedTypeException( 'PostGreSQL', $matches[1] );
        }
