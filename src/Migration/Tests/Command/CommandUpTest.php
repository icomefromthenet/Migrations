...
class CommandUpTest extends AbstractProjectWithFixture
{
    ...
    public function testUpMigration()
    {
        ...
        $this->assertContains('Migration up to 1346389177',$commandTester->getDisplay());
    }
    ...
    public function testUpMigrationForce()
    {
        ...
        $this->assertContains('DEMO.A         | Y      | Migration up to 1346389018',$commandTester->getDisplay());
    }
