...
class CommandRunTest extends AbstractProjectWithFixture
{
    ...
    public function testRunDefaultsUpDirection()
    {
        ...
        $this->assertContains('DEMO.A         | Y      | Migration up 1346381977',$commandTester->getDisplay());
    }
    ...
    public function testRunWithDownDirection()
    {
        ...
        $this->assertContains('DEMO.A         | Y      | Migration down 1346381787',$commandTester->getDisplay());
    }
