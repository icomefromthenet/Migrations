...
use Migration\Components\Migration\Driver\SQLite\SchemaManager;
use Migration\Tests\Base\AbstractProjectWithDb;

class SqliteSchemaManagerTest extends AbstractProjectWithDb
{
    ...
    {
        $builder = $this->db_builder;
        $this->assertEquals($builder->getDatabase()->getDatabasePlatform()->getName(),'sqlite');
        
        # sqlite can not drop a foreign key must remove table to remove key
    ...
    public function testDropTable()
    {
        ...
        $builder->dropTable('Genre',$schema_manager);
    ...
    public function testDropView()
    {
        $builder = $this->db_builder;
        $schema_manager = $builder->getDatabase()->getSchemaManager(); 
        $builder->dropView('KAlbum',$schema_manager);
        $this->assertTrue(true);
    }
    /*
    ...
    */
    ...
    {
        $connection    = $this->getDoctrineConnection('sqlite');        
