...
/**
 * File containing the DbFactory class.
 *
 * @package Database
 * @version 1.4.7
...
/**
 * DbFactory manages the list of known database drivers
...
class Factory
{
     ...
     */
    static private $implementations = array( 'mysql'  => 'Migration\\Database\\Handlers\\Mysql',
                                             'pgsql'  => 'Migration\\Database\\Handlers\\Pgsql',
                                             'oracle' => 'Migration\\Database\\Handlers\\Oracle',
                                             'sqlite' => 'Migration\\Database\\Handlers\\Sqlite',
                                             'mssql' =>  'Migration\\Database\\Handlers\\Mssql', );
     ...
     * {
     * }
     * DbFactory::addImplementation( 'msql', 'Migration\Database\Handlers\Msql' );
     * // ...
    ...
    /**
     * Creates and returns an instance of the specified DbHandler implementation.
     *
     ...
     *
     * @throws HandlerNotFoundException if the requested database handler could not be found.
    ...
    static public function create( $dbParams )
    {
        ...
        else if ( \is_array( $dbParams ) === FALSE )
        {
            throw new ValueException( 'dbParams', $dbParams, 'string or array', 'parameter' );
        }
        ...
        {
            throw new HandlerNotFoundException( $impName, \array_keys( self::$implementations ) );
        }
