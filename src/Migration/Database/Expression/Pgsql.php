...
use Migration\Database\Query\Query;
use Migration\Database\Query\Select;

/**
 * File containing the Pgsql class.
 *
 * @package Database
 * @version 1.4.7
...
/**
 * The Pgsql class is used to create SQL expression for PostgreSQL.
 *
 ...
 * @version 1.4.7
 */
class Pgsql extends Expression
{
    /**
     ...
     *
     * @throws QueryVariableParameterException if no parameters are provided.
    ...
    public function concat()
    {
        ...
        if ( count( $cols ) < 1 )
        {
            throw new QueryVariableParameterException( 'select', \count( $args ), 1 );
        }
