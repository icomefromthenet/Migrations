...
/**
 * The QueryExpressionOracle class is used to create SQL expression for Oracle.
 *
 ...
 * @version 1.4.7
 */
class Oracle extends Expression
{
    /**
     * Constructs an empty QueryExpression
     *
     * @param PDO $db
     */
     ...
     *
     * @throws QueryVariableException if no parameters are provided
...
//            }
    ...
    public function in( $column )
    {
        ...
        {
            throw new QueryInvalidParameterException( 'in', 2, 'empty array', 'non-empty array' );
        }
