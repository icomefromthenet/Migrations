...
/**
 * File containing the Query class.
 *
 * @package Database
 * @version 1.4.7
...
/**
 * The Query class provides the common API for all Query objects.
 *
 * Query has three main purposes:
...
abstract class Query
{
    ...
    /**
     * Constructs a new Query that works on the database $db and with the aliases $aliases.
     *
    ...
    public function bindValue( $value, $placeHolder = null, $type = PDO::PARAM_STR )
    {
        ...
        {
            $this->boundCounter++;
            $placeHolder = ":Value{$this->boundCounter}";
        }
     ...
     *
     * @todo public? Currently this is needed for Expression.
     * @param array $array
     * @return array
     */
    ...
    /**
     * Returns the SubSelect query object.
     *
     * This method creates new QuerySubSelect object
     ...
     *
     * @throws QueryInvalidException if it was not possible to build a valid query.
     * @return string
     */
