...
/**
 * File containing the Insert class.
 *
 * @package Database
 * @version 1.4.7
 ...
 * Example:
 * <code>
 * $q = Instance::get()->createInsertQuery();
...
class Insert extends Query
{
    ...
    /**
     * Constructs a new QueryInsert that works on the database $db and with the aliases $aliases.
     *
    ...
    public function getQuery()
    {
        if ( $this->table == null || empty( $this->values ) )
        {
            ...
            throw new QueryInvalidException( "INSERT", "No " . $problem . " set." );
        }
