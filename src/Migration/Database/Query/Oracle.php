...
/**
 * Oracle specific implementation of Query.
 *
 * This class reimplements methods where Oracle differs from
 * the standard implementation in Query.Most notably LIMIT
...
class Oracle extends Select
{
    ...
    /**
     * Constructs a new Oracle object working on the database $db.
     *
     * @param \PDO $db
     */
