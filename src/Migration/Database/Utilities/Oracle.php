...
/**
 * File containing the Utilities class.
 *
 * @package Database
 * @version 1.4.7
 ...
 * @version 1.4.7
 */
class Oracle extends Utilities
{
    /**
     ...
     *
     * @throws Exception::GENERIC_ERROR in case of inability to generate
     *         a unique temporary table name.
     * @see Migration\Database\Handler::createTemporaryTable()
     *
     *
