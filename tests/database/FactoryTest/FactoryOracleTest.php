...
/*
 * class FactoryOracleTest
 */

class FactoryOracleTest extends FactoryBase {

   public function setup()
    {
        if ( !Features::hasExtensionSupport( 'pdo_oracle') )  {
            $this->markTestSkipped('Pdo Oracle extension does not exist');
            return;
        }
    ...
    */
    ...
    {
        $db = Factory::create( array( 'handler' => 'oracle' ) );
    }
}
